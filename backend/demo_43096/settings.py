"""
Django settings for demo_43096 project.
...
WSGI_APPLICATION = 'demo_43096.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demo_43096 API",
    "DESCRIPTION": "API documentation for demo_43096 App",
    "VERSION": "v1",
}
